...
def get_args():
    ...
    system_args = {
        # expeirment info
        'project'       : 'Multilingual-Train',
        'name'          : 'HM-Conformer FR',
        'tags'          : [],
        'description'   : '',
        ...
        'selected_language': 'fr',  # Filter for English only. Change to other language codes (e.g., 'it', 'es') or None for all languages
